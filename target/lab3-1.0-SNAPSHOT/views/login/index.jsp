...
<html lang="en">
  <head>
    ...
    <link href="<%=request.getContextPath()%>/login/assets/docs.css" rel="stylesheet">

    <!-- Debug -->
    <script src="//localhost:32123/livereload.js"></script>

    <!-- This is what you need -->
    <script src="<%=request.getContextPath()%>/login/dist/sweetalert.js"></script>
    <link rel="stylesheet" href="<%=request.getContextPath()%>/login/dist/sweetalert.css">
    <!--.......................-->
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="examples">
        <button class="btn btn-lg btn-primary sweet-10" onclick="helo()">Primary</button>
